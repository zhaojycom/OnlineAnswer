 ...
 * @data:On 2019/2/3.
 */
public class AddUserSortPresenter implements Presenter {
    private final String TAG = AddUserSortPresenter.class.getSimpleName();
    ...
    public AddUserSortPresenter(Context mContext) {
     ...
     * 添加用户的题目分类
     */
    public synchronized void addUserSort(int sortId) {
        if (!end) {
            return;
        }
        end = false;
        ...
        mCompositeSubscription.add(manager.addUserSort(body)
