 ...
 * @data:On 2019/3/1.
 */
public class BaikeHeroQuestionsPresenter implements Presenter {
    private final String TAG = BaikeHeroQuestionsPresenter.class.getSimpleName();
    ...
    public BaikeHeroQuestionsPresenter(Context mContext) {
     ...
     */
    public void getBaikeHeroQuestions(int difficultId) {
        ...
        mCompositeSubscription.add(manager.getBaikeHeroQuestions(body)
