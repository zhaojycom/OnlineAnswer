...
public class SubmitQuestionsPresenter implements Presenter {
    private final String TAG = SubmitQuestionsPresenter.class.getSimpleName();
    ...
    public SubmitQuestionsPresenter(Context mContext) {
     ...
     */
    public void submitQuestion(List<Question> questionList) {
        ...
        mCompositeSubscription.add(manager.submitQuestion(body)
