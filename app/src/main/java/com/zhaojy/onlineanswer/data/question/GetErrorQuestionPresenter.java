 ...
 * @data:On 2019/1/27.
 */
public class GetErrorQuestionPresenter implements Presenter {
    private final String TAG = GetErrorQuestionPresenter.class.getSimpleName();
    ...
    public GetErrorQuestionPresenter(Context mContext) {
     ...
     * @param sortId 题目分类id
     */
    public void getErrorQuestions(int sortId) {
        ...
        mCompositeSubscription.add(manager.getErrorQuestions(body)
